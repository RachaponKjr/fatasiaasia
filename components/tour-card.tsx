...
const TourCard = () => {
  return (
    <div className="bg-white shadow-[0px_4px_20px_-3px_#000000]/25 h-max w-full rounded-3xl flex flex-col items-start overflow-hidden">
      {/* Image */}
      ...
      <div className="p-10">
        <div className="flex flex-col gap-4">
          ...
          <div className="text-[#7D7D7D] font-normal text-[13px] flex gap-2 mt-2">
            <h6>estimate</h6>
            <span className="text-sm font-medium text-[#2F2F2F]">$771</span>
            <h6>/person</h6>
          </div>
        </div>
      </div>
