...
const ContryCard = () => {
  return (
    <div className="w-full aspect-[13/16] bg-neutral-300 rounded-3xl p-8 flex items-end relative overflow-hidden">
      ...
      <div className="flex flex-col z-10">
        <span className="text-[#EFB933] font-medium text-lg leading-none">
          Travel To
        </span>
        <h4 className="font-medium text-4xl text-[#FFFFFF] leading-none">
          Thailand
        </h4>
      </div>
    </div>
