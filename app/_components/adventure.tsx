...
const Adventure = () => {
  ...
  return (
    <LayoutSection title="Adventure & Activity">
      <div className="grid grid-cols-2 xl:grid-cols-5 gap-4 xl:gap-10">
        {adventureList.map((item, i) => (
          <div className="bg-white rounded-3xl grow py-4 xl:py-16 flex flex-col items-center justify-center gap-4 shadow-lg">
