  ...
  return (
    <div className="col-span-2 flex flex-col gap-8 items-center">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <span className="font-normal text-xl text-[#333333] text-center max-w-lg">
          We are checking on availability and will get back to you within 24 to 48 hours with a confirmation and payment link.
        </span>
      </div>
      <Button
